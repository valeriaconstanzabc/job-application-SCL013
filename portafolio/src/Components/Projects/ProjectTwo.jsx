                ...
                <div id="containerLinksProjectTwo">
                    <div className="container">
                        <div className="content">
                            ...
                            <img className="content-image" alt="Logo del proyecto" src="https://i.ibb.co/WWH8MFM/Group-21.png"/>
                            <div className="content-details fadeIn-bottom">
                                <h3 className="content-title">¡Visita <br/> La guía muggle!</h3>
                            </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="content">
                            ...
                            <div className="content-overlay"></div>
                            <img className="content-image" alt="Código del proyecto" src="https://i.ibb.co/Swh7gZR/Group-19.png"/>
                            <div className="content-details fadeIn-bottom">
